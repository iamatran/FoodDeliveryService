...
namespace FoodDeliveryService.Controllers
{
    ...
    public class OrderValuesController : Controller
    {
        ...
        public IEnumerable<Order> GetOrders()
        {
            ...
            .Include(o => o.Foods).Include(o => o.Payment);
        }
        [HttpPost("{id}")]
        ...
        public IActionResult CreateOrder([FromBody] Order order)
        {
            if (ModelState.IsValid)
            {
                order.OrderId = 0;
                order.Shipped = false;
                order.Payment.Total = GetPrice(order.Foods);
        ...
        {
            IEnumerable<long> ids = lines.Select(l => l.FoodId);
            return context.Foods
            .Where(m => ids.Contains(m.FoodId))
            .Select(m => lines
            .First(l => l.FoodId == m.FoodId).Quantity * m.Price)
            .Sum();
        }
